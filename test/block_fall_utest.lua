...
describe('ブロックの落下', function()
  ...
  describe('ブロックが 1 つだけ落ちる', function()
    ...
    it("着地後 1 フレームで状態が idle になる", function()
      ...
      assert.is_true(block._state == "idle")
    end)
  end)
  ...
  describe('ブロックが 2 つ積み重なったまま落ちる', function()
    ...
    it("着地後 1 フレームで状態が idle になる", function()
      ...
      assert.is_true(block1._state == "idle")
      assert.is_true(block2._state == "idle")
    end)
  end)
  ...
  describe('CNOT が落ちる', function()
    ...
    it("着地後 1 フレームで状態が idle になる", function()
      ...
      assert.is_true(control._state == "idle")
      assert.is_true(cnot_x._state == "idle")
    end)
  end)
  ...
  describe('SWAP ブロックが落ちる', function()
    ...
    it("着地後 1 フレームで状態が idle になる", function()
      ...
      assert.is_true(swap_left._state == "idle")
      assert.is_true(swap_right._state == "idle")
    end)
  ...
  describe('おじゃまブロックが落ちる', function()
    ...
    it("着地後 1 フレームで状態が idle になる", function()
      ...
      assert.is_true(garbage._state == "idle")
    end)
  end)
end)
