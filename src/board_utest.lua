...
describe('board', function()
  ...
  describe('is_gate_empty', function()
    it('おじゃまユニタリの領域は空ではない', function()
      ...
      assert.is_true(board:is_gate_empty(1, 11))
      assert.is_false(board:is_gate_empty(2, 11))
      assert.is_false(board:is_gate_empty(3, 11))
      assert.is_false(board:is_gate_empty(4, 11))
      assert.is_false(board:is_gate_empty(5, 11))
      assert.is_true(board:is_gate_empty(6, 11))
    end)
