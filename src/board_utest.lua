...
describe('board', function()
  ...
  describe('swap', function()
    it('should swap gates next to each other', function()
      ...
      assert.are_equal("h", board:gate_at(1, 12)._type)
      assert.are_equal("x", board:gate_at(2, 12)._type)
    ...
    it('should not swap gates if the left gate is in swap', function()
      ...
      assert.are_equal("x", board:gate_at(3, 12)._type)
  ...
  describe('reduce_gates', function()
    ...
    it('should reduce SS', function()
      ...
      assert.is_true(board:gate_at(1, 11)._reduce_to:is_i())
      assert.are_equal("z", board:gate_at(1, 12)._reduce_to._type)
    end)
    ...
    it('should reduce TT', function()
      ...
      assert.is_true(board:gate_at(1, 11)._reduce_to:is_i())
      assert.are_equal("s", board:gate_at(1, 12)._reduce_to._type)
    end)
    ...
    it('should reduce XZ', function()
      ...
      assert.is_true(board:gate_at(1, 11)._reduce_to:is_i())
      assert.are_equal("y", board:gate_at(1, 12)._reduce_to._type)
    end)
    ...
    it('should reduce HZH', function()
      ...
      assert.is_true(board:gate_at(1, 10)._reduce_to:is_i())
      assert.is_true(board:gate_at(1, 11)._reduce_to:is_i())
      assert.are_equal("x", board:gate_at(1, 12)._reduce_to._type)
    end)
    ...
    it('should reduce C-X X-C C-X', function()
      ...
      assert.is_true(board:gate_at(1, 11)._reduce_to:is_i())
      assert.is_true(board:gate_at(3, 11)._reduce_to:is_i())
      assert.are_equal("swap", board:gate_at(1, 12)._reduce_to._type)
      assert.are_equal(3, board:gate_at(1, 12)._reduce_to.other_x)
      assert.are_equal("swap", board:gate_at(3, 12)._reduce_to._type)
    ...
    it('should reduce HH C-X HH', function()
      ...
      assert.is_true(board:gate_at(1, 10)._reduce_to:is_i())
      assert.is_true(board:gate_at(3, 10)._reduce_to:is_i())
      assert.are_equal("cnot_x", board:gate_at(1, 11)._reduce_to._type)
      assert.are_equal(3, board:gate_at(1, 11)._reduce_to.other_x)
      assert.are_equal("control", board:gate_at(3, 11)._reduce_to._type)
    ...
    it('should reduce HH X-C HH', function()
      ...
      assert.is_true(board:gate_at(1, 10)._reduce_to:is_i())
      assert.is_true(board:gate_at(3, 10)._reduce_to:is_i())
      assert.are_equal("control", board:gate_at(1, 11)._reduce_to._type)
      assert.are_equal(3, board:gate_at(1, 11)._reduce_to.other_x)
      assert.are_equal("cnot_x", board:gate_at(3, 11)._reduce_to._type)
      assert.are_equal(1, board:gate_at(3, 11)._reduce_to.other_x)
      assert.is_true(board:gate_at(1, 12)._reduce_to:is_i())
      assert.is_true(board:gate_at(3, 12)._reduce_to:is_i())
    end)
    ...
    it('should reduce XX C-X X', function()
      ...
      assert.is_true(board:gate_at(1, 10)._reduce_to:is_i())
      assert.is_true(board:gate_at(3, 10)._reduce_to:is_i())
      assert.are_equal("control", board:gate_at(1, 11)._type)
      assert.are_equal("cnot_x", board:gate_at(3, 11)._type)
      assert.is_true(board:gate_at(1, 12)._reduce_to:is_i())
    end)
    ...
    it('should reduce XX X-C X', function()
      ...
      assert.is_true(board:gate_at(1, 10)._reduce_to:is_i())
      assert.is_true(board:gate_at(3, 10)._reduce_to:is_i())
      assert.are_equal("cnot_x", board:gate_at(1, 11)._type)
      assert.are_equal("control", board:gate_at(3, 11)._type)
      assert.is_true(board:gate_at(3, 12)._reduce_to:is_i())
    end)
    ...
    it('H S-S H を簡約する', function()
      ...
      assert.is_true(board:gate_at(1, 10)._reduce_to:is_i())
      assert.are_equal("swap", board:gate_at(1, 11)._type)
      assert.are_equal("swap", board:gate_at(3, 11)._type)
      assert.is_true(board:gate_at(3, 12)._reduce_to:is_i())
    end)
    ...
    it('should reduce Z S-S Z', function()
      ...
      assert.are_equal("swap", board:gate_at(2, 11)._type)
      assert.are_equal("swap", board:gate_at(4, 11)._type)
    ...
    it('should reduce S S-S S', function()
      ...
      assert.are_equal("z", board:gate_at(1, 10)._reduce_to._type)
      assert.are_equal("swap", board:gate_at(1, 11)._type)
      assert.are_equal("swap", board:gate_at(3, 11)._type)
      assert.is_true(board:gate_at(3, 12)._reduce_to:is_i())
    end)
    ...
    it('should reduce T S-S T', function()
      ...
      assert.are_equal("s", board:gate_at(1, 10)._reduce_to._type)
      assert.are_equal("swap", board:gate_at(1, 11)._type)
      assert.are_equal("swap", board:gate_at(3, 11)._type)
      assert.is_true(board:gate_at(3, 12)._reduce_to:is_i())
    end)
    ...
    --   assert.is_true(board:gate_at(3, 10)._reduce_to:is_i())
    --   assert.is_true(board:gate_at(1, 11)._type)
    --   assert.is_true(board:gate_at(3, 11)._type)
  ...
  describe('update', function()
    ...
    it('swap ペアの真ん中が消えた時に正しく落ちる', function()
      ...
      assert.are_equal("swap", board:gate_at(1, 3)._type)
      assert.are_equal("swap", board:gate_at(3, 3)._type)
    end)
    ...
    it('CNOT 下のゲートを入れ替えて落としたときに消えない', function()
      ...
      assert.are_equal("s", board:gate_at(5, 12)._type)
    end)
  end)
