...
function particle:_create(x, y, radius, end_radius, __color, __color_fade, dx, dy, ddx, ddy, max_tick)
  self:_add(function(_ENV)
    ...
    x, y, dx == "random" and rnd(1.2) * .8 or dx, dy == "random" and rnd(1.2) * .8 or dy, radius, end_radius, __color,
        __color_fade, 0, max_tick + rnd(10), ddx, ddy
...
function particle._update(_ENV, all)
