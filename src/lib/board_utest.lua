...
describe('board', function()
  ...
  before_each(function()
    board = create_board(player_cursor_class())
  end)
  ...
  describe('swap', function()
    ...
    it('should not swap blocks if the left gate is in swap', function()
    ...
    it('should not swap blocks if the right gate is in swap', function()
      board:put(1, 16, h_gate())
      board:put(2, 16, x_gate())
